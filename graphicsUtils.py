...
def square(pos, r, fillColor, outlineColor = None, filled=1, behind=0):
    if not outlineColor:
        outlineColor = fillColor

    x, y = pos
    coords = [(x - r, y - r), (x + r, y - r), (x + r, y + r), (x - r, y + r)]
    return polygon(coords, outlineColor, fillColor, filled, 0, behind=behind)
